...
public class HPRNSchedulerTest extends BaseSchedulerTest {
  public HPRNSchedulerTest(String name) {
    super(name);
  }
  ...
  protected Scheduler getSchedulerForFile(
    ...
    return new HPRNScheduler(inputReader, randomNumberReader, verbose,
                             showRandom);
  }
